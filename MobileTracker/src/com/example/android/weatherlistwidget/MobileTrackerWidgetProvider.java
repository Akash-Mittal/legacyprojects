 ...
 */
class MobileDataProviderObserver extends ContentObserver {
    private AppWidgetManager mAppWidgetManager;
    private ComponentName mComponentName;

    MobileDataProviderObserver(AppWidgetManager mgr, ComponentName cn, Handler h) {
        super(h);
 ...
 */
public class MobileTrackerWidgetProvider extends AppWidgetProvider {
    ...
    private static MobileDataProviderObserver sDataObserver;

    public MobileTrackerWidgetProvider() {
    ...
    public void onEnabled(Context context) {
        ...
        if (sDataObserver == null) {
            ...
            final ComponentName cn = new ComponentName(context, MobileTrackerWidgetProvider.class);
            sDataObserver = new MobileDataProviderObserver(mgr, cn, sWorkerQueue);
            r.registerContentObserver(MobileTrackerDataProvider.CONTENT_URI, true, sDataObserver);
        }
    }
    ...
    public void onReceive(Context ctx, Intent intent) {
        ...
        if (action.equals(REFRESH_ACTION)) {
            ...
            sWorkerQueue.post(new Runnable() {
                public void run() {
                    final ContentResolver r = context.getContentResolver();
                    final Cursor c = r.query(MobileTrackerDataProvider.CONTENT_URI, null, null, null, 
                            null);
                    ...
                    for (int i = 0; i < count; ++i) {
                        final Uri uri = ContentUris.withAppendedId(MobileTrackerDataProvider.CONTENT_URI, i);
                        final ContentValues values = new ContentValues();
                        values.put(MobileTrackerDataProvider.Columns.TEMPERATURE,
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < appWidgetIds.length; ++i) {
            ...
            final Intent intent = new Intent(context, MobileTrackerWidgetService.class);
            ...
            // ignored otherwise.
            final Intent onClickIntent = new Intent(context, MobileTrackerWidgetProvider.class);
            onClickIntent.setAction(MobileTrackerWidgetProvider.CLICK_ACTION);
            ...
            final Intent refreshIntent = new Intent(context, MobileTrackerWidgetProvider.class);
            refreshIntent.setAction(MobileTrackerWidgetProvider.REFRESH_ACTION);
