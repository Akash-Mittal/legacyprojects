 ...
 */
class MobileDataPoint {
    String city;
    int degrees;

    MobileDataPoint(String c, int d) {
        city = c;
        degrees = d;
    }
}
 ...
 */
public class MobileTrackerDataProvider extends ContentProvider {
     ...
     */
    private static final ArrayList<MobileDataPoint> sData = new ArrayList<MobileDataPoint>();

    @Override
    public boolean onCreate() {
        // We are going to initialize the data provider with some default values
        sData.add(new MobileDataPoint("San Francisco", 13));
        sData.add(new MobileDataPoint("New York", 1));
        sData.add(new MobileDataPoint("Seattle", 7));
        sData.add(new MobileDataPoint("Boston", 4));
        sData.add(new MobileDataPoint("Miami", 22));
        sData.add(new MobileDataPoint("Toronto", -10));
        sData.add(new MobileDataPoint("Calgary", -13));
        sData.add(new MobileDataPoint("Tokyo", 8));
        sData.add(new MobileDataPoint("Kyoto", 11));
        sData.add(new MobileDataPoint("London", -1));
        sData.add(new MobileDataPoint("Nomanisan", 27));
        return true;
    }
    ...
    public synchronized Cursor query(Uri uri, String[] projection, String selection,
        ...
        for (int i = 0; i < sData.size(); ++i) {
            final MobileDataPoint data = sData.get(i);
    ...
    public synchronized int update(Uri uri, ContentValues values, String selection,
        ...
        final MobileDataPoint data = sData.get(index);
