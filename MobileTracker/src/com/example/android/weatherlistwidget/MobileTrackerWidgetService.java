 ...
 */
public class MobileTrackerWidgetService extends RemoteViewsService {
    @Override
...
class StackRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        if (mCursor.moveToPosition(position)) {
            final int cityColIndex = mCursor.getColumnIndex(MobileTrackerDataProvider.Columns.CITY);
            final int tempColIndex = mCursor.getColumnIndex(
                    MobileTrackerDataProvider.Columns.TEMPERATURE);
        ...
        extras.putString(MobileTrackerWidgetProvider.EXTRA_CITY_ID, city);
    ...
    public void onDataSetChanged() {
        ...
        mCursor = mContext.getContentResolver().query(MobileTrackerDataProvider.CONTENT_URI, null, null,
                null, null);
    }
}
